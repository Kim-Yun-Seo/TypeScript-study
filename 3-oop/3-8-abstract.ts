{
  ...
  //상속을 할 때 어떤 특정한 기능만 자식에서 수행할때
  //abtract 클래스를 사용할 수 있음.
  type CoffeeCup = {
    shots: number;
    hasMilk?: boolean;
    hasSugar?: boolean; 
  ...
  //abstract 키워드를 사용하면 그 자체로는 인스턴스를 할 수 없음.
  //밑에서 에러남.
  abstract class CoffeeMachine implements CoffeeMaker {
    ...
    //자식클래스마다 다르게 구현되는 애들앞에 abstract를 붙임.
    //그리고 이제 자식이 접근을 해야하기 때문에 private은 안됨.
    protected abstract extract(shots: number): CoffeeCup 
      //이제 추상적이게 돼서 부연설명ㅇ은 할 필요가 없음.
